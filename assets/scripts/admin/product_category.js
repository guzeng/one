...
function appendRootNode()
{
    ...
    var tr_html = "<tr class='tr_node'><td colspan='2'>"+
                    "<div id='0_name_condition_edit' style='margin-bottom:0'>"+select+
                        "<label class='radio-inline' style='padding-left: 0px;'><input name='name' class='form-control' placeholder='商品分类名称' id='0_name_input' maxlength='30' type='text'></label>"+
...
function updateCategory(id)
{
    ...
    $.ajax({
        url:msg.base_url+'admin/product_cate/update',
        data:data,
        dataType:'json',
        type:'post',
        beforeSend:function(){
...
function confirm_delete_category(id)
{
    if(typeof(id) != 'undefined')
    {
        var uri = msg.base_url+"admin/product_cate/delete/"+id;
