...
<div class='col-lg-2 col-md-3 col-sm-3 col-xs-12 col-no-padding my-left-menu'>         
  <div class="page-sidebar nav-collapse">
    <ul class="nav">
        ...
        <li <?if($controller_name=='users' && in_array($method_name, array('consume','previously_consume'))):?>class="active"<?endif?> ><a href="<?php echo base_url().'home/';?>users/consume">消费记录</a></li>
