<?$this->load->view('admin/header');?>
				...
				<div class="col-md-12">
					...
					<div class="portlet box blue" id='list-box'>
						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="buy_history_list">
								<thead>
									<tr>
										<th width='20%'>用户名</th>
										<th width='*'>商品</th>
	...
	<script >
		jQuery(document).ready(function() {
		    ...
		    // begin first table
		    nTable = $('#buy_history_list').dataTable({
		        ...
		        "bProcessing": true,
		        "bServerSide": true,
		        "sAjaxSource": msg.base_url+"admin/statistic/buy_datalist/",
		    ...
		    initDataTableAction('buy_history_list',nTable);
