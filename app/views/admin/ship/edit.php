				...
				<div class="col-md-12" id="">
					<div class="portlet box blue">
						<div class="portlet-body ">
							<!-- BEGIN FORM-->
							<form action="<?php echo base_url()?>admin/ship_type/update" class="horizontal-form" id='ship-type-edit'>
								<div class="form-body">
									<div class="row">
										<div class="col-md-12">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" id="billing" name='billing' class="form-control" maxLength='100' placeholder="100字符以内" value="<?php echo isset($row)?$row->billing:''?>">
												<span class="help-block"></span>
											</div>
										</div>
										<!--/span-->
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea id="info" name='info' class="form-control" placeholder="备注"><?php echo isset($row)?$row->info:''?></textarea>
												<span class="help-block"></span>
											</div>
										</div>
										<!--/span-->
								...
								<div class="form-actions right">
									<button type="button" onclick="do_submit('ship-type-edit')" class="btn green"><i class="fa fa-save"></i> 保存</button>
