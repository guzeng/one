				...
				<div class="col-md-12" id="">
					<div class="portlet box blue">
						<div class="portlet-body ">
							<!-- BEGIN FORM-->
							<form action="<?php echo base_url()?>admin/storages/update" class="horizontal-form" id='storage-edit'>
								<div class="form-body">
									<div class="row">
										<div class="col-md-12">
								...
								<div class="form-actions text-center">
									<button type="button" onclick="do_submit('storage-edit')" class="btn green"><i class="fa fa-save"></i> 保存</button>
