		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active ">
					<a href="javascript:void(0)" onclick="load_page('admin/index/dashboard')">
				...
				<li class="">
					...
					<ul class="sub-menu">
						<li >
							<a href="javascript:void(0)" onclick="load_page('admin/products')">
							所有商品
							</a>
						</li>
						<li >
							<a href="javascript:void(0)" onclick="load_page('admin/product_category')">
							商品分类
							</a>
						</li>
					</ul>
