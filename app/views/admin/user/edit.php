									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" id="username" name='username' class="form-control" maxLength='20' placeholder="20字符以内" value="<?php echo isset($row)?$row->username:''?>">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label"><span class='req'>*</span> 姓名</label>
