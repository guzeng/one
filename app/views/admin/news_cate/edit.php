			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?php echo base_url();?>admin/news_cate">文章分类</a>
							<?if(isset($row)):?>
							<i class="fa fa-angle-right"></i>
							<?endif;?>
						</li>
				...
				<div class="col-md-12" id="">
					<div class="portlet box blue">
						<div class="portlet-body ">
							<!-- BEGIN FORM-->
							<form action="<?php echo base_url()?>admin/news_cate/update" class="horizontal-form" id='news-cate-edit'>
								<div class="form-body">
									<div class="row">
										<div class="col-md-6">
								...
								<div class="form-actions right">
									<button type="button" onclick="do_submit('news-cate-edit')" class="btn green"><i class="fa fa-save"></i> 保存</button>
