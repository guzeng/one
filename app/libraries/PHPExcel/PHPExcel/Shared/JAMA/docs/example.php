<?phPHPExcel-1.7.6 "includes/header.php"PHPExcel-1.7.6 "includes/navbar.php";
?>
...
<?php
highlight_file("../examples/MagicSquareExample.php")PHPExcel-1.7.6 "includes/footer.php";	
?>
