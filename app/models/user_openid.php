...
class User_openid extends CI_Model{
	private $table='user_openid';
	...
	public function get_by_openid($id){
		if($id){
...
/* End of file user_openid.php */
/* Location: ./application/models/user_openid.php */	